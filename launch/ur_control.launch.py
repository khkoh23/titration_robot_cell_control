# Modified from https://github.com/UniversalRobots/Universal_Robots_ROS2_Driver/blob/jazzy/ur_robot_driver/launch/ur_control.launch.py
...
def launch_setup(context):
    ...
    trajectory_until_node = Node(
        package="titration_robot_cell_control",
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "rviz_config_file",
            default_value=PathJoinSubstitution(
                [FindPackageShare("titration_robot_cell_description"), "rviz", "urdf.rviz"]
            ),
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare("titration_robot_cell_control"), "config", "sim_robot_calibration.yaml"]
            ),
        )
    )
